...
public interface ICommonDao {
	...
	public <T> List<T> queryBusinessObjs(Class<T> cls, final String sql,
			final int startRecord, final int maxRecord,
			final SqlParameter... params) throws SQLException;
	...
	public <T> PaginationSupport<T> queryByPagedQuery(Class<T> cls,
			final String sql, final int startPage, final int pageSize,
			final SqlParameter... params) throws SQLException;
	 ...
	 * @throws Exception
	 */
	public int update(final String sql, final SqlParameter... params)
			throws SQLException;
	 ...
	 * @throws Exception
	 */
	public boolean execute(final String sql, final SqlParameter... params)
			throws SQLException;
