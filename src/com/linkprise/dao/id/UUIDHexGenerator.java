	...
	public Serializable generate(Dialect dialect, ICommonDao dao, Object pojo,
		...
		try {
			String idval = new StringBuffer(36)
					.append(UUIDHelper.format(UUIDHelper.getAddressInt()))
					.append(separator)
					.append(UUIDHelper.format(UUIDHelper.getJvmIdentifierInt()))
					.append(separator).append(UUIDHelper.format(getHiTime()))
					.append(separator).append(UUIDHelper.format(getLoTime()))
					.append(separator)
